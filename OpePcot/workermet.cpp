...
WorkerMet::WorkerMet(QObject *parent, QList < Proceso*> listaProcesos) :
    Worker(parent, listaProcesos)
{

}
void WorkerMet::siguienteProceso()
{
    ...
    {
        if(contadorProceso==2 && !_operacionActual->getDataZoneProyect()->getFootPrintMask())
        {
